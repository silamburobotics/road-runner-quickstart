...
@Config
@TeleOp(name = "TeleOpDECODEStates", group = "TeleOp")
public class TeleOpDECODEStates extends LinearOpMode {
    ...
    public static final double ALIGNMENT_TURN_VELOCITY = 300;  // Velocity (ticks/sec) for alignment turns
