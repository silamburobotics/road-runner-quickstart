...
@Config
@Autonomous(name = "Auto Red Near2", group = "Red Alliance")
public class AutoDECODERedNear2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addData("1.", "Trajectory 1 - Move left 50 inches");
        telemetry.addData("2.", "Shooter - Fire 3 shots");
        telemetry.addData("3.", "Trajectory 2 - Move backward 24 inches");
        telemetry.addData("", "");
    ...
    private void buildTrajectoryActions() {
        ...
        // Trajectory 1: Move left 50 inches (same as Blue)
        trajectory1 = drive.actionBuilder(START_POSE)
                .lineToX(START_POSE.position.x - REARWARD_DISTANCE)
                .build();
        
        // Trajectory 2: Move backward 24 inches (reversed direction from Blue)
        trajectory2 = drive.actionBuilder(new Pose2d(START_POSE.position.x - REARWARD_DISTANCE, START_POSE.position.y, START_POSE.heading.toDouble()))
                .strafeToLinearHeading(new Vector2d(START_POSE.position.x - REARWARD_DISTANCE, START_POSE.position.y - LEFTWARD_DISTANCE), START_POSE.heading.toDouble())
                .build();
        
        telemetry.addData("✅ Trajectory 1", "Built (move left %.1f inches)", REARWARD_DISTANCE);
        telemetry.addData("✅ Trajectory 2", "Built (move backward %.1f inches)", LEFTWARD_DISTANCE);
        telemetry.update();
    }
    ...
    private void executeAutonomousSequence() {
        ...
        // Step 1: Execute Trajectory 1 (move left)
        ...
        // Step 3: Execute Trajectory 2 (move backward)
        ...
        telemetry.addData("🔴 Alliance", "RED");
        telemetry.addData("📍 Final Position", "50\" left, 24\" backward");
