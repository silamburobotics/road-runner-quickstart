...
public class AutoDECODERedNear extends LinearOpMode {
    ...
    public static double SHOOTER_TARGET_VELOCITY = 1230;      // Range: 1200-1800 ticks/sec (Red back position)
 ...
 // Road Runner trajectory settings
    ...
    private void buildTrajectoryActions() {
        ...
        trajectory1 = drive.actionBuilder(START_POSE)
                .lineToX(START_POSE.position.x - REARWARD_DISTANCE)  // Move left 50 inches (same as Red)
                .build();
        ...
        trajectory2 = drive.actionBuilder(new Pose2d(START_POSE.position.x - REARWARD_DISTANCE, START_POSE.position.y, START_POSE.heading.toDouble()))
         ...
         trajectoryCloseOut = drive.actionBuilder(new Pose2d(START_POSE.position.x - REARWARD_DISTANCE, START_POSE.position.y, START_POSE.heading.toDouble()))
                .strafeToLinearHeading(new Vector2d(START_POSE.position.x - REARWARD_DISTANCE, START_POSE.position.y - LEFTWARD_DISTANCE), START_POSE.heading.toDouble())  // Strafe backward 24 inches (reversed direction for red)
                .build();
