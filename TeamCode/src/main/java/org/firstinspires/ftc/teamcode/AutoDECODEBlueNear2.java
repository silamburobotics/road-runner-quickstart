...
@Config
@Autonomous(name = "Auto Blue Near2", group = "Blue Alliance")
public class AutoDECODEBlueNear2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addData("3.", "Trajectory 2 - Move forward 24 inches");
        telemetry.addData("", "");
    ...
    private void buildTrajectoryActions() {
        ...
        // Trajectory 1: Move left 50 inches
        trajectory1 = drive.actionBuilder(START_POSE)
                .lineToX(START_POSE.position.x - REARWARD_DISTANCE)
                .build();
        
        // Trajectory 2: Move forward 24 inches (perpendicular to first movement)
        ...
        telemetry.addData("✅ Trajectory 2", "Built (move forward %.1f inches)", LEFTWARD_DISTANCE);
        telemetry.update();
    }
    ...
    private void executeAutonomousSequence() {
        ...
        // Step 3: Execute Trajectory 2 (move forward)
        ...
        telemetry.addData("🔵 Alliance", "BLUE");
        telemetry.addData("📍 Final Position", "50\" left, 24\" forward");
