...
public class AutoDECODEBlueNearPlus extends LinearOpMode {
    ...
    public static double SHOOTER_TARGET_VELOCITY = 1160;      // Range: 1200-1800 ticks/sec (Blue back position)
 ...
 // Road Runner trajectory settings
    ...
    private void buildTrajectoryActions() {
        ...
        trajectory2 = drive.actionBuilder(new Pose2d(START_POSE.position.x - REARWARD_DISTANCE, START_POSE.position.y, START_POSE.heading.toDouble()))
                ...
                .strafeToLinearHeading(new Vector2d(START_POSE.position.x - REARWARD_DISTANCE + 1.0, START_POSE.position.y), Math.toRadians(-133)) //10.0
